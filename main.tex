...
\usepackage[numbers]{natbib}% Use the natbib reference package - read up on this to edit the reference style; if you want text (e.g. Smith et al., 2012) for the in-text references (instead of numbers), remove 'numbers' v
...
\unisite{http://www.cit.ac.in}
\depsite{http://www.cit.ac.in/department/CSE}
\placeshrt{Kokrajhar}
\placelng{Kokrajhar - 783370, India}
\datesub{\today}
\datesig{\today}
\semsub{Odd Semester, 2023-24}
\keywords{Neural Machine Translation, Low-Resource Languages, Cross-Language Communication, Language Diversity, Machine Learning, Natural Language Processing}
\coursecd{M.Tech Project (PCSE391)}
